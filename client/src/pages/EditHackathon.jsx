        ...
        const fetchHackathon = async () => {
            try {
                ...
                if (hackathon) {
                    ...
                    setNotificationsEnabled(hackathon.notificationsEnabled !== false);
    ...
    return (
        <div className="max-w-3xl mx-auto py-6">
            <div className="mb-8">
                ...
                <h1 className="text-4xl font-bold text-gray-900">Edit Hackathon</h1>
                <p className="text-gray-600 mt-2">Update your hackathon details and deadlines</p>
            </div>
